...
foreach ($answers as $questionId => $answer) {
    ...
    $stmt = $conn->prepare("SELECT correct_answer, quiz_id FROM re_quiz WHERE id = ?");
...
$stmt = $conn->prepare("INSERT INTO re_results (student_id, quiz_id, score, total_questions, correct_answers, submitted_at) VALUES (?, ?, ?, ?, ?, NOW())");
