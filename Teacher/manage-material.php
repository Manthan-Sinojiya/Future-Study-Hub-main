                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT m.material_id, m.material_name, m.description, m.pdf_path, s.sub_name 
                                                                FROM material m 
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <!-- View Material (PDF) -->
                                                                        <a href="<?php echo htmlentities($result->pdf_path); ?>" target="_blank">
                                                                            <i  class="fa fa-book fa-2x" title="View Material" style="color:#259fff;"></i>
                                                                        </a>
                                                                        <!-- Update Material -->
                                                                        <a href="update-material.php?material_id=<?php echo htmlentities($result->material_id); ?>">
                                                                            <i class="fa fa-pencil fa-2x" title="Update this Material" style="color:#0cc100;"></i>
                                                                        </a>
                                                                        <!-- Delete Material -->
                                                                        <a href="manage-material.php?material_id=<?php echo htmlentities($result->material_id); ?>" onclick="return confirm('Do you really want to delete the material?');">
