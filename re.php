...
$query = "SELECT exam_time FROM re_quiz WHERE quiz_id = ?";
        ...
        function renderQuestions(questions) {
            ...
            questions.forEach(function(question) {
                ...
                <div class="card question-card">
                    <div class="card-body">
                        ${question.img_path ? `<img src="./teacher/uploads/${question.img_path}" class="img-fluid" alt="Question Image">` : ''}
